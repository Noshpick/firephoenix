  ...
  return (
    <div className="w-full max-w-[420px] mx-auto">
      <div className="relative w-full h-auto max-w-[420px]">
        <img
          src="/cardless.svg"
          alt={t("lessons.packGroup.cardAlt")}
          ...
          >
            <span
              className="block text-[#604127] font-inter leading-snug whitespace-pre-line
                        max-[767px]:text-[18px] sm:text-[20px] md:text-[12px] lg:text-[16px] xl:text-[18px]"
            >
              {t("lessons.packGroup.description")}
            </span>
            ...
            <span
              className="block text-[#62432B] font-inter font-semibold leading-none 
                        ...
                        min-[840px]:!mt-[15%]"
            >
              {t("lessons.packGroup.price")}
            </span>
          </div>

          <div className="mt-[4%] sm:mt-[10%] md:mt-[2%] lg:mt-[10%] max-[767px]:scale-110 md:scale-115 lg:scale-120 xl:scale-[1.25]">
            <BtnSignUp />
          </div>
        </div>
      </div>
