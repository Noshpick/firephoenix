  ...
  return (
    <div className="w-full max-w-[420px] mx-auto">
      <div className="relative w-full h-auto max-w-[420px]">
        <img
          src="/cardless.svg"
          alt={t("lessons.oneGroup.cardAlt")}
        ...
        <div className="absolute top-0 left-0 w-full h-full flex flex-col items-center text-center px-4">
          ...
          >
            {t("lessons.oneGroup.title")}
          </span>

          <div
            className="max-[767px]:mt-[4%] sm:mt-[5%] md:mt-[3%] lg:mt-[5%]
            w-[95%] md:w-[90%] min-[840px]:!w-[200px] lg:!w-[250px] xl:!w-[95%]
          ...
          >
            ...
            >
              {t("lessons.oneGroup.description")}
            </span>
            ...
            <span
              className="block text-[#62432B] font-inter font-semibold leading-none 
                        ...
                        max-[767px]:mt-0 sm:mt-7 md:mt-5
                        min-[840px]:!mt-[10%]
                        lg:mt-[11.5%]
                        min-[1280px]:!mt-[14%]"
            >
              {t("lessons.oneGroup.price")}
            </span>
          </div>
