  ...
  return (
    <div className="w-full max-w-[420px] mx-auto">
      <div className="relative w-full h-auto max-w-[420px]">
        <img
          src="/cardless.svg"
          alt={t("lessons.courseGroup.cardAlt")}
          ...
          >
            ...
            <span
              className="block text-[#62432B] font-inter font-semibold leading-none 
                        ...
                        max-[767px]:mt-0 sm:mt-7 md:mt-[14%]
                        min-[840px]:!mt-[15%]
                        lg:!mt-[15%]
                        min-[1280px]:!mt-[15%]"
            >
              {t("lessons.courseGroup.price")}
            </span>
          </div>
