...
type BtnSignUpProps = { className?: string };

export default function BtnSignUp({ className = "" }: BtnSignUpProps) {
  const { t } = useI18n();
  ...
  return (
    <a
      ...
      className={`w-full md:w-auto inline-flex items-center justify-center min-w-0 whitespace-nowrap
                  ...
                  transition-colors duration-300 cursor-pointer shadow-md z-[100] ${className}`}
    >
      <span
